...
&emsp;&emsp;RNN的一个突出的缺点是不能保留超过几个（大约7个）时间步长之外的信息，因此缺乏长期记忆。长短期记忆网络 **（Long Short-Term Memory，LSTM）** 是可封装长期记忆的RNN扩展版本。因此，LSTM通常优于标准RNN。我们将在 _第7章长期短期记忆网络_ 中深入探讨，以便更好地理解它们。  
&emsp;&emsp;
&emsp;&emsp;
&emsp;&emsp;
&emsp;&emsp;
